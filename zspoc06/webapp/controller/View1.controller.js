sap.ui.define([
    ...
    BusyIndicator) {
        ...
        return Controller.extend("zspoc06.controller.View1", {
            onInit: function () {
                window.view1 = this;
            ...
            onPressPricing : function(){
                ...
                var salesOrderNumber = window.zspoc06.getView().getModel("salesList").getProperty(sPath + "/SalesOrderNumber")
            ...
            onPressRejectAll : function(){
                ...
                oModel.setData({
                    values:window.zspoc06.getView().getModel("rejectReason").oData
                });
            ...
            aFilter: function(){
                ...
                for(var oFilterItem of aFilterItems){
                    ...
                    if(oControl.getId() == "container-zspoc06---View1--oSearch"){
