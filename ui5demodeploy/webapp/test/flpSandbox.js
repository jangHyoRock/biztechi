		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5DEMO",
									"targetURL": "#ui5demodeploy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5demodeploy-display": {
								"semanticObject": "ui5demodeploy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5demodeploy",
									"url": sap.ui.require.toUrl("ui5demodeploy")
								}
							}
						}
					}
